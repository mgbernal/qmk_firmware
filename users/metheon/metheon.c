...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL3_BSE] = LAYOUT_metheon(
        XXXXXXX ,KC_TAB  ,KC_Q    ,BL3_W   ,KC_E    ,KC_R    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,KC_ESC  ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,TO_BASE ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,XXXXXXX ,KC_LCTL ,KC_G    ,KC_V    ,BL3_SPC ,BL3_SPC ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        BL3_BSE_E01 ,BL3_BSE_E02
    ),
    [_BL3_UPR] = LAYOUT_metheon(
        XXXXXXX ,_______ ,KC_1    ,_______ ,KC_2    ,KC_3    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,_______ ,_______ ,_______ ,_______ ,KC_4    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,_______ ,KC_M    ,KC_I    ,KC_L    ,KC_K    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,XXXXXXX ,XXXXXXX ,KC_LBRC ,KC_RBRC ,_______ ,_______ ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        BL3_UPR_E01 ,BL3_UPR_E02
    )
};
// clang-format on
